@if ($paginator->hasPages())
    <nav class="pagination is-centered">
        ...
        @else
            <a href="{{ $paginator->previousPageUrl() }}" rel="prev" class="pagination-previous"><span>&laquo;</span></a>
        @endif

        @if ($paginator->hasMorePages())
            <a class="pagination-next" href="{{ $paginator->nextPageUrl() }}" rel="next"><span>&raquo;</span></a>
        @else
